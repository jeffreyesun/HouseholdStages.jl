...
"""
MigrationStage(layout::GriddedLayout; location_axis::Symbol=:location, migration_cost, ε=1.0) =
    LogitChoiceStage(layout; choice_axis=location_axis, cost_matrix=migration_cost, ε=ε)
